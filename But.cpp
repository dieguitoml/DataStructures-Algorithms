...
public:
    ...
    bool nueva_reserva(int inicio, int fin, string nombre) {//Esta función tendría orden o(n) siendo n el numero de reservas
        ...
        if (f != l)return false;
            ...
            for (int i = num_reservas; i > l; i--)reservas[i] = reservas[i - 1];
    ...
    int busquedaBin1(int elem, int ini, int fin)const {//Esta funcion es una busqueda binaria, luego tendria orden o(logn), donde n es el numero de reservas
